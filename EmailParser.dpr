...
uses
  ...
  ExcelReader.Helper in 'Sources\Excel\ExcelReader.Helper.pas' {EXIF.Dialog in 'Sources\Common\EXIF.Dialog.pas' {EXIFDialog},
  ...
  Thread.HTTPClient in 'Sources\DataModules\Thread.HTTPClient.pas',
  ...
  Utils.Files in 'Sources\Common\Utils.Files.pas',

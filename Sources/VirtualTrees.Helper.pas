...
uses
  ...
  CustomForms, HtmlLib, VirtualTrees, DaModule, HtmlConsts, System.StrUtils, Utils, System.Generics.Defaults,
        ...
        COL_ITEMS:
          begin
            case Data^.DocType of
              ...
              ntOrder:
                begin
                  if (Data^.OrderDoc.OrderStatus in [osFilled, osPartlyFilled, osPendSubmit, osPreSubmit, osSubmitted])
                  then
                  ...
                  if (Data^.OrderDoc.OrderAction = iabBuy) then
                    ...
                    TargetCanvas.Font.Color := clWebPaleVioletRed
                  else
                    TargetCanvas.Font.Color := clMaroon;
                end;
              ntCondition:
    ...
    case TTreeDocument.GetDocType(Sender, Node) of
        ...
        case Column of
          COL_ITEMS:
            CellText := Format('%s %s[%s] [%s] %s', [Data^.OrderDoc.InstrumentName,
                                                     ...
                                                     BrokersAbbrevName[Data^.OrderDoc.BrokerType],
      ...
      ntCondition:
        case Column of
          ...
          COL_CALCTYPE:
            CellText := Data^.ConditionDoc.ConditionToString;
          COL_VALUE:
        ...
        case Column of
          COL_ITEMS:
            ...
            begin
              ...
              if (Data^.FactorDoc.BrokerType = IBBroker) then

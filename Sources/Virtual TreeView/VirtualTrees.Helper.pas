...
begin
  ...
  Sender.TreeOptions.AutoOptions      := Sender.TreeOptions.AutoOptions + [{toDisableAutoscrollOnFocus, toAutoScroll,} toAutoDropExpand, toAutoTristateTracking, toAutoChangeScale];

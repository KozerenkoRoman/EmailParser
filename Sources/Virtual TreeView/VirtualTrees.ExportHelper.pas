...
type
  ...
  public
    ...
    class function GetNodesList(aNode: PVirtualNode; aIsRecursive: Boolean = True): TNodeArray;
  end;
...
class function TExcelExportHelper.GetNodesList(aNode: PVirtualNode; aIsRecursive: Boolean = True): TNodeArray;
var
